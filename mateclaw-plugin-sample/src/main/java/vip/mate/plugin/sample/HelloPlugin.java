...
/**
 * Sample plugin demonstrating the QingwenClaws Plugin SDK.
 * <p>
 * Registers a simple "hello_world" tool that agents can call.
 *
 * @author 擎问科技 (Qingwen Tech)
 */
public class HelloPlugin implements MateClawPlugin {
    ...
    public String hello_world(
        ...
        return "Hello, " + name + "! This message comes from the QingwenClaws Hello World plugin.";
    }
}
