...
VALUES (1000002100, 1000000003, 'dateTimeTool',        TRUE, NOW(), NOW(), 0)
ON DUPLICATE KEY UPDATE tool_name = VALUES(tool_name);

INSERT INTO mate_agent_tool (id, agent_id, tool_name, enabled, create_time, update_time, deleted)
VALUES (1000002101, 1000000003, 'webSearchTool',       TRUE, NOW(), NOW(), 0)
ON DUPLICATE KEY UPDATE tool_name = VALUES(tool_name);

INSERT INTO mate_agent_tool (id, agent_id, tool_name, enabled, create_time, update_time, deleted)
VALUES (1000002102, 1000000003, 'workspaceMemoryTool', TRUE, NOW(), NOW(), 0)
ON DUPLICATE KEY UPDATE tool_name = VALUES(tool_name);

INSERT INTO mate_agent_tool (id, agent_id, tool_name, enabled, create_time, update_time, deleted)
VALUES (1000002103, 1000000003, 'wikiTool',            TRUE, NOW(), NOW(), 0)
ON DUPLICATE KEY UPDATE tool_name = VALUES(tool_name);

INSERT INTO mate_agent_tool (id, agent_id, tool_name, enabled, create_time, update_time, deleted)
VALUES (1000002104, 1000000003, 'readFileTool',        TRUE, NOW(), NOW(), 0)
ON DUPLICATE KEY UPDATE tool_name = VALUES(tool_name);

INSERT INTO mate_agent_tool (id, agent_id, tool_name, enabled, create_time, update_time, deleted)
VALUES (1000002105, 1000000003, 'documentExtractTool', TRUE, NOW(), NOW(), 0)
ON DUPLICATE KEY UPDATE tool_name = VALUES(tool_name);
