export default {
  ...
  settings: {
    ...
    model: {
      ...
      claudeCodeOauthRevokeHint: 'Sign out from the Claude Code app to revoke. SurveyMind does not modify Claude Code\'s on-disk credentials.',
    ...
    multimodalDesc: 'Manage image generation, TTS/STT, video, music, and 3D model provider settings in one place',
  ...
  agents: {
    ...
    intro: {
      title: 'What is a Digital Employee?',
      body: 'A digital employee is a configured AI role you "hire": pick its brain (model), grant it expertise (skills/tools), set its job rules (prompt). It then works for you across chat, channels, and scheduled jobs.',
      bullets: {
        a: 'One employee = model + skills + tools + prompt + memory',
        b: 'Can be on duty across multiple channels (Web, Lark, DingTalk, …)',
        c: 'Every decision and tool call is auditable',
      },
      footer: 'Hire → pick model → bind skills → test chat → wire a channel. Four steps end-to-end.',
      hide: 'Don\'t show again',
      show: 'What is a Digital Employee?',
    },
  ...
  security: {
    ...
    activity: {
      ...
      intro: {
        ...
        body: 'The activity log is SurveyMind\'s black box. Every user action, agent decision, tool invocation, and approval outcome is recorded in time order — for triage, compliance, and after-the-fact reviews.',
        bullets: {
          a: 'Audit events — who changed what, when, from where',
          b: 'Approval events — which sensitive tool calls were gated',
          c: 'Click any row for the full request, response, and context',
        },
        footer: 'When something looks off ("why did the agent reply like that?"), start here.',
        hide: 'Don\'t show again',
        show: 'What is the Activity Log?',
      },
  ...
  acp: {
    ...
    env: {
      ...
      hints: {
        ...
        dashscope: 'Aliyun DashScope key — same value as SurveyMind .env DASHSCOPE_API_KEY',
  ...
  plugins: {
    ...
    intro: {
      ...
      bullets: {
        ...
        c: 'Best for deep system integration and private API access',
      },
      footer: 'For simple scripts, prefer a Skill. Reach for a plugin when you need real Java integration.',
      hide: 'Don\'t show again',
      show: 'What is a Plugin?',
    },
    refresh: 'Refresh',
    type: 'Type',
    author: 'Author',
    ...
    emptyHint: 'Place plugin JAR files in ~/.qingwenclaws/plugins/ and restart the server',
  ...
  cronJobs: {
    ...
    intro: {
      ...
      body: 'A cron job fires a digital employee on a schedule — daily briefings, weekly checks, hourly data pulls, or a one-shot future run. Equivalent to "someone sent a message at that time" from the agent\'s point of view.',
      bullets: {
        a: 'Behaves exactly like a manual chat trigger — same prompt, same tools',
        b: 'Distributed-lock protected: fires once even with multiple replicas',
        c: 'Pause / resume / replay anytime; full history is auditable',
      },
      footer: 'Tip: get the employee working in chat first, then clone the same input into a cron job.',
      hide: 'Don\'t show again',
      show: 'What is a Cron Job?',
    },
    createJob: 'New Job',
    editJob: 'Edit Job',
  ...
  workflows: {
    ...
    desc: 'Orchestrate multi-step processes as automated pipelines: assign each step to an employee, with parallel execution, conditional branches, human approvals, and cross-channel delivery.',
    intro: {
      title: 'What can a Workflow do?',
      body: 'An employee is a person — you chat, it figures things out. A workflow is an SOP — you define every step, who does it, and what happens on failure; once triggered it runs end-to-end unattended.',
      bullets: {
        a: 'Chain multiple employees: A drafts → B reviews → C translates → push to DingTalk, fully unattended',
        b: 'Approval gates: pause at any step until a designated person clicks "Approve"',
        c: 'Auto-trigger: run on schedule, on incoming messages, or when an upstream workflow completes',
      },
      footer: 'Can you draw the flowchart upfront? → Build a workflow. Need the AI to figure it out? → Chat with an employee.',
      hide: 'Don\'t show again',
      show: 'What can a Workflow do?',
    },
    ...
    templates: {
      ...
      sequential: 'Sequential — runs after the previous step',
      fan_out: 'Fan-out — runs multiple steps in parallel',
      collect: 'Collect — waits for parallel steps, merges results',
      conditional: 'Conditional — runs only when condition is met',
      await_approval: 'Await approval — pauses until a person approves',
      dispatch_channel: 'Dispatch — pushes result to channels',
      write_memory: 'Write memory — saves result into employee memory',
    },
    ...
    canvas: {
      ...
      modeHints: {
        sequential: 'runs after the previous step finishes',
        fan_out: 'runs multiple steps in parallel',
        collect: 'waits for all parallel steps, merges results',
        conditional: 'runs only when condition is met',
        await_approval: 'pauses until a person approves',
        dispatch_channel: 'pushes result to DingTalk / Feishu / etc.',
        write_memory: 'saves result into an employee\'s memory',
      },
      inspector: {
  ...
  login: {
    ...
    heroDesc: 'SurveyMind is not about stuffing more capability into a chat box. It is about pulling context, knowledge, execution, and memory into one reliable operating surface.',
  ...
  channels: {
    ...
    intro: {
      ...
      body: 'A channel is how a digital employee speaks to the outside world — DingTalk group, Lark bot, WeCom, Web Chat, webhook, and so on. Once a channel is configured, the employee can naturally send and receive messages there.',
      bullets: {
        a: 'One employee can serve multiple channels simultaneously',
        b: 'Channels are isolated — one failing channel does not poison the others',
        c: 'Every inbound and outbound message is auditable',
      },
      footer: 'Suggested order: prove the employee in Web Chat, then bind an IM channel for internal beta, then roll it out.',
      hide: 'Don\'t show again',
      show: 'What is a Channel?',
    },
    ...
    webchatHint: 'WebChat embeds the SurveyMind chat widget into external websites. Configure an API key, title, and primary color, then load the WebChat SDK on your site.',
  ...
  skills: {
    ...
    aiCreateSkill: 'AI Create',
    aiCreateSkillTooltip: 'Build a skill step-by-step through a natural language conversation',
    aiCreateSkillOpening: 'Opening...',
    aiCreateSkillDisabled: 'The Skill Builder agent is currently disabled. Enable it on the Agents page and try again.',
    skillBuilderMissingTitle: 'Skill Builder Not Found',
    skillBuilderMissingDesc: 'The "Skill Builder" agent does not exist or has been deleted.\n\nTo use AI-assisted skill creation, please recreate it on the Agents page with the following configuration:\n\n• Name: Skill Builder\n• Agent type: react\n• Bind skill: skill-creator (built-in)\n• Authorize tool: skill_manage\n\nGo to the Agents page now?',
    skillBuilderGoCreate: 'Go to Agents',
    ...
    intro: {
      ...
      body: 'A Skill is a "capability pack" you give your digital employees. Each skill bundles domain know-how, a set of tools the agent may call, and rules for when to use them.',
      bullets: {
        a: 'Teach the agent to handle specific formats like Word, Excel, or PDF.',
        b: 'Let the agent reach for the right tool — browser, SQL, API — at the right moment.',
        c: 'Plug new capabilities into your agents like installing an app.',
      },
      footer: 'Browse by category below, click Enable to add a skill to your library, then bind it to an agent in the Agents page.',
      hide: 'Don\'t show again',
      show: 'What is a Skill?',
    },
    groups: {
      office: 'Office Documents',
      data: 'Data & SQL',
      retrieval: 'Web & Research',
      channel: 'Messaging & Collaboration',
      schedule: 'Scheduling & Triggers',
      browser: 'Browser / RPA',
      devops: 'Engineering & Debug',
      design: 'Design & Visualization',
      mateclaw: 'SurveyMind Self-Help',
      extension: 'More Extensions',
    },
    groupHints: {
      extension: 'Rarely used or experimental — enable as needed',
    },
    expand: 'Expand',
    collapse: 'Collapse',
    search: {
  ...
  onboarding: {
    ...
    send: 'Send',
    startUsing: 'Start Using SurveyMind',
    skip: 'Skip',
    back: 'Back',
  },
  talk: {
  ...
  memory: {
    ...
    intro: {
      ...
      body: 'Memory is your digital employee\'s long-term brain. Conversations distill into reusable facts, preferences, and procedures so the next conversation doesn\'t start from zero. The system extracts and consolidates on a schedule; you can also edit by hand.',
      bullets: {
        a: 'AGENTS.md / PROFILE.md / SOUL.md — role and user profile',
        b: 'MEMORY.md — day-to-day facts, preferences, project context',
        c: 'Nightly Dreaming dedupes, merges, and drops stale entries',
      },
      footer: 'Memory is why the employee gets better over time. Audit it occasionally — it lets you catch and correct things it got wrong.',
      hide: 'Don\'t show again',
      show: 'What is Memory?',
    },
    selectAgent: 'Select Agent',
  ...
  toolLabels: {
    ...
    readSurveyMindDoc: 'Read System Docs',
  ...
  analytics: {
    ...
    semanticHint: 'Describe the business meaning of this column — it will be injected into the analyst agent context',
    ...
    guidanceUpload: 'Upload Files',
    guidanceUploadDesc: 'Have Excel/CSV? Upload and let AI analyze instantly',
    guidanceConnect: 'Connect Database',
    guidanceConnectDesc: 'Have MySQL, PostgreSQL, ClickHouse? Connect and let AI query directly',
  },
  license: {
    trialActive: 'Trial',
