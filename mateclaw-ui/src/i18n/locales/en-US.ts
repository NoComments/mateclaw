export default {
  ...
  workflows: {
    ...
    intro: {
      ...
      body: 'A workflow is an orchestrated script: "do A, then B, fan out to C and D in parallel, fall back to E on error." More structured than a single chat turn — and ideal for chaining multiple employees and tools.',
      bullets: {
        a: 'Seven step modes: sequential, fan-out, collect, conditional, approval, channel, memory-write',
        b: 'JSON-first DSL with Pebble templating; revisions can be published and rolled back',
        c: 'Triggers from chat, cron jobs, webhooks, or completion events',
      },
      footer: 'Start with a linear 3-step model, get it working, then add branches and parallelism.',
      hide: 'Don\'t show again',
      show: 'What is a Workflow?',
    },
