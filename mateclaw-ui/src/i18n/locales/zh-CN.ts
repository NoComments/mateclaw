export default {
  ...
  workflows: {
    ...
    intro: {
      title: '什么是工作流？',
      body: '工作流是一份可编排的"剧本"：定义"先做 A、再做 B、并行做 C/D、出错就走 E"这种多步业务流程。比一个员工的单轮对话更结构化、更稳定，可以串联多个员工与工具。',
      bullets: {
        a: '七种步骤：顺序、扇出、合并、条件、人工审批、推送渠道、写入记忆',
        b: 'JSON 优先，支持 Pebble 模板变量，可发布与回滚版本',
        c: '可被对话、定时任务或事件触发自动跑',
      },
      footer: '建议从简单的"线性 3 步"开始建模型，跑通后再加分支与并行。',
      hide: '不再提示',
      show: '了解什么是工作流',
    },
    newWorkflow: '+ 新建工作流',
