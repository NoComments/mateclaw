    ...
    <div class="mc-page-frame">
      <div class="mc-page-inner">
        ...
        <div class="guidance-area">
          <div class="guidance-card" @click="goToUpload()">
...
// Uploading an Excel requires an existing dataset, so this entry point lands on
// the dataset list and asks it to open the create dialog.
function goToUpload() {
  router.push({ path: '/analytics/datasets', query: { action: 'create' } })
}
</script>
