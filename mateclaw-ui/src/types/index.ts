...
export const CHANNEL_FIELD_DEFS: Record<string, ChannelFieldDef[]> = {
  ...
  feishu: [
    ...
    { key: 'media_download_enabled', label: '媒体下载', placeholder: '', type: 'switch', defaultValue: false, tooltip: '下载消息中的图片和文件到本地（保存至 ~/.qingwenclaws/media/feishu/）' },
  ],
  telegram: [
  ...
  webchat: [
    ...
    { key: 'title', label: '标题', placeholder: 'QingwenClaws', type: 'text', defaultValue: 'QingwenClaws', tooltip: '聊天面板顶部显示的标题' },
